...
export class WebSocketService<T = any> {
    ...
    constructor (private url: string, private protocol?: string, private onMessage?: (data: T) => void, private needHeartBeat = false) {
        this.init()
    }
    ...
    /** 发送消息 */
    public send <T extends string | ArrayBufferLike | Blob | ArrayBufferView<ArrayBufferLike> = string> (message: T) {
