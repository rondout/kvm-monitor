 ...
 */
import { Janus, JANUS_ERROR_TO_JANUS_ENUM_MAP } from '@renderer/tools/janus'
// import { useKvmStore, type KvmConfigState, type StreamInfoTuple } from '@renderer/stores/modules/kvm'
...
// import { createVolumeMeter } from '@renderer/tools/media'

type AnyFunction = (...args: any[]) => any

export const $ = (id: string) =>
  document.getElementById(id) as HTMLVideoElement & HTMLImageElement & HTMLMediaElement
