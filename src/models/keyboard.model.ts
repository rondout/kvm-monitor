...
export class KeyboardKeyWithCustomShrink extends KeyboardKey { 
    constructor (public code: AllKeyboardKeys,
        public title: string,
        public subtitle?: string,
        public shrink = 1,
        ...
        super(code, title, subtitle, undefined, lockStatus, withLock, withDot, ledPosition, titlePosition, subtitlePosition, isGutter)
    }
}
...
export class KeyboardKeyWithShortCut extends KeyboardKey implements KeyboardKeyType {
    constructor (public code: AllKeyboardKeys,
        ...
        super(code, title, subtitle, width, lockStatus, withLock, withDot, ledPosition, titlePosition, subtitlePosition, isGutter)
    }
}
...
export class KeyboardKeyWithDot extends KeyboardKey {
    constructor (public code: AllKeyboardKeys,
        ...
        super(code, title, subtitle, width, lockStatus, withLock, true, ledPosition, titlePosition, subtitlePosition, isGutter)
    }
}
...
/** 虚拟键盘的按键以及布局 */
export const  genKeyboardKeyList = (config?: HidEventState['keyboard']['leds']): KeyboardKeyLayout => {
    return {
        left: [
            [   new KeyboardKey(AllKeyboardKeys.Escape, 'Esc', undefined, undefined, undefined, undefined, undefined, undefined, 'left'),
                TinyKeyGutter,
            ...
            [
                ...
                new KeyboardKeyWithCustomShrink(AllKeyboardKeys.Backspace, 'Backspace', undefined, 1.5, 'right')            ],
            [
            ...
            [
                new KeyboardKeyWithCustomShrink(AllKeyboardKeys.CapsLock, 'Caps', undefined, 1.75, 'left', config?.caps, true, undefined, 'right'),
            ...
            [
                ...
                new KeyboardKeyWithCustomShrink(AllKeyboardKeys.ContextMenu, 'Menu', undefined, 1.5, 'right'),
                new KeyboardKeyWithCustomShrink(AllKeyboardKeys.ControlRight, 'Ctrl', undefined, 1.5, 'right'),
            ],
        ],
        right: [
            [
                new KeyboardKey(AllKeyboardKeys.PrintScreen, 'Pt/Sq'),
                new KeyboardKey(AllKeyboardKeys.ScrollLock, 'ScrLk', undefined, undefined, config?.scroll, true),
        ...
        bottom: [
            [
                ...
                new KeyboardKeyWithShortCut(AllKeyboardKeys.ScrollLock, 'ScrLk', ['Scr','Lk'], undefined, undefined, config?.scroll, true),
        ...
        bottomRight: [
            [
                KeyGutter,
                new KeyboardKey(AllKeyboardKeys.ArrowUp, '↑'),
                KeyGutter,
            ],
            [
                new KeyboardKey(AllKeyboardKeys.ArrowLeft, '←'),
...
/** 内置的、默认的键盘快捷键 */
export const DEFAULT_KEY_SHORTCUTS: KeyShortcutsInfo[] = shortcutKeyOptions.map(item => KeyboardShortcutConfigMap.get(item.value))
...
// @ts-ignore
Object.values(genKeyboardKeyList()).flat().flat().forEach((item: KeyboardItemType) => {
    if (item.isGutter) {
        return
    }
