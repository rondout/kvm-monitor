...
import loginBgLight from '@/assets/images/login-bg-light.png'
import loginBgDark from '@/assets/images/login-bg-dark.png'
import remotePlanet from '@/assets/svg/access-remote-planet.svg'
import remotePlanetDark from '@/assets/images/access-remote-planet-dark.png'
import remoteAstronaut from '@/assets/svg/access-remote-astronaut.svg'
import bindCode from '@/assets/images/cloud/bind-code.png'
import bindCodeZh from '@/assets/images/cloud/bind-code-zh.png'
