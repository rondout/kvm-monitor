...
var require_logger_plugin = __commonJS({
  "node_modules/http-proxy-middleware/dist/utils/logger-plugin.js"(exports2) {
    ...
    function getPort(sockets) {
      var _a, _b;
      return (_b = (_a = Object.keys(sockets || {})) == null ? void 0 : _a[0]) == null ? void 0 : _b.split(":")[1];
    }
  }
});
...
var require_logger_plugin2 = __commonJS({
  "node_modules/http-proxy-middleware/dist/plugins/default/logger-plugin.js"(exports2) {
    ...
    var loggerPlugin = (proxyServer, options) => {
      ...
      proxyServer.on("error", (err, req, res, target) => {
        var _a;
        const hostname = (_a = req == null ? void 0 : req.headers) == null ? void 0 : _a.host;
        const requestHref = `${hostname}${req == null ? void 0 : req.url}`;
        const targetHref = `${target == null ? void 0 : target.href}`;
      ...
      proxyServer.on("proxyRes", (proxyRes, req, res) => {
        ...
        let target;
        try {
          const port = (0, logger_plugin_1.getPort)((_b = (_a = proxyRes.req) == null ? void 0 : _a.agent) == null ? void 0 : _b.sockets);
          const obj = {
...
var require_get_plugins = __commonJS({
  "node_modules/http-proxy-middleware/dist/get-plugins.js"(exports2) {
    ...
    function getPlugins(options) {
      var _a;
      const maybeErrorResponsePlugin = ((_a = options.on) == null ? void 0 : _a.error) ? [] : [default_1.errorResponsePlugin];
...
var require_path_filter = __commonJS({
  "node_modules/http-proxy-middleware/dist/path-filter.js"(exports2) {
    ...
    function matchSingleStringPath(pathFilter, uri) {
      const pathname = getUrlPathName(uri);
      return (pathname == null ? void 0 : pathname.indexOf(pathFilter)) === 0;
    }
        ...
        this.middleware = (async (req, res, next) => {
          ...
          if (this.shouldProxy(this.proxyOptions.pathFilter, req)) {
            try {
              ...
              next == null ? void 0 : next(err);
            }
          } else {
            next == null ? void 0 : next();
          }
          const server2 = (_a = req.socket ?? req.connection) == null ? void 0 : _a.server;
...
var deviceProxies = /* @__PURE__ */ new Map();
app.post("/api/kvm/add", async (req, res) => {
  const id = (0, import_nanoid.default)();
  try {
...
server.on("upgrade", (req, socket, head) => {
  var _a;
  try {
    const deviceId = (_a = req.url) == null ? void 0 : _a.split("/")[2];
